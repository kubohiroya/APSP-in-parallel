...
all: $(SEQ) $(OMP) $(CUDA) $(SEQ_ISPC) $(OMP_ISPC) $(SEQ_LIB) $(OMP_LIB) $(CUDA_LIB) $(SEQ_ISPC_LIB) $(OMP_ISPC_LIB)
else
# CXXFLAGS += -I/opt/boost-1.61.0/include -I$(SRC_DIR)/
#$(OMP) $(OMP_ISPC) $(CUDA): CXXFLAGS += -Xpreprocessor -fopenmp
all: $(SEQ) $(OMP) $(SEQ_ISPC) $(OMP_ISPC) $(SEQ_LIB) $(OMP_LIB) $(SEQ_ISPC_LIB) $(OMP_ISPC_LIB)
endif
