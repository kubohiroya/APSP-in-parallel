...
graph_t_double *init_graph_double(const int *adjacencyMatrix, const int n, const int e);
...
void johnson_cuda_double(graph_cuda_t_double *gr, double *distanceMatrix, int *successorMatrix);
